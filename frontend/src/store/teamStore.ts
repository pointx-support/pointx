...
export const useTeamStore = create<TeamStoreState>((set, get) => ({
  ...
  createGlobalTeam: (teamData) => {
    ...
    teamsApi.create(teamData).catch(() => {});
    return newTeam;
  },
  ...
  updateGlobalTeam: (id, updates) => {
    ...
    teamsApi.update(id, updates).catch(() => {});
  },
  ...
  addGlobalPlayer: (teamId, playerData) => {
    ...
    teamsApi.addPlayer(teamId, playerData).catch(() => {});
    return newPlayer;
  },
  ...
  updateGlobalPlayer: (teamId, playerId, updates) => {
    ...
    teamsApi.updatePlayer(teamId, playerId, updates).catch(() => {});
  },
  ...
  deleteGlobalPlayer: (teamId, playerId) => {
    ...
    teamsApi.deletePlayer(teamId, playerId).catch(() => {});
  },
