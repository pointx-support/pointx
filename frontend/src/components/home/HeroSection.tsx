  ...
  return (
    <div className="relative w-full overflow-hidden bg-[var(--bg-base)] transition-colors duration-300">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-12 pt-24 pb-16">
        ...
        {/* Ambient Glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] md:w-[850px] h-[320px] md:h-[420px] bg-[var(--accent-primary)]/10 dark:bg-[var(--accent-primary)]/15 rounded-full blur-[140px] pointer-events-none z-0" />
