...
export const Modal: React.FC<ModalProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center p-0 sm:p-4 font-sans animate-fadeIn">
      ...
      <div
        className={`relative z-10 w-full ${maxWidthStyles} rounded-t-3xl sm:rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] shadow-[var(--shadow-floating)] overflow-hidden flex flex-col max-h-[88vh] sm:max-h-[90vh] animate-modal-enter`}
      >
