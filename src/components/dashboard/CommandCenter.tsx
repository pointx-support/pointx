...
export const CommandCenter: React.FC<CommandCenterProps> = ({ onSelectTournament }) => {
  ...
  return (
    <div className="space-y-8 font-sans w-full max-w-[1680px] mx-auto animate-page-enter">
      ...
      <section className="relative rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-hero)] overflow-hidden shadow-[var(--shadow-raised)] p-6 sm:p-10 lg:p-12 text-center">
        
        {/* Subtle, soft ambient highlight behind logo */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] sm:w-[500px] h-[180px] sm:h-[240px] bg-[var(--accent-primary)]/8 rounded-full blur-[90px] pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center max-w-3xl mx-auto space-y-5 sm:space-y-6">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[var(--accent-primary)]/12 border border-[var(--accent-primary)]/30 backdrop-blur-md text-[var(--accent-primary-text)] dark:text-[var(--accent-primary)] shadow-sm">
          ...
          <div className="relative flex h-20 sm:h-26 md:h-32 w-auto max-w-[280px] sm:max-w-[400px] md:max-w-[480px] items-center justify-center p-1 group">
            <div className="absolute inset-0 bg-[var(--accent-primary)]/12 rounded-3xl blur-xl group-hover:bg-[var(--accent-primary)]/22 transition-all duration-500" />
            <div className="relative z-10">
              <PointXLogo
                className="w-full h-full object-contain select-none drop-shadow-[0_6px_20px_rgba(0,0,0,0.4)] dark:drop-shadow-[0_6px_20px_rgba(0,0,0,0.7)]"
                withShine={true}
              />
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4 font-mono">
        {/* TOTAL TOURNAMENTS */}
        <div className="relative rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface-subtle)] p-4 sm:p-5 shadow-[var(--shadow-flat)] hover:border-[var(--accent-primary)]/50 transition-all group overflow-hidden">
          {/* Subtle Accent Strip */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[var(--accent-primary)]/12 text-[var(--accent-primary)] border border-[var(--accent-primary)]/25 group-hover:scale-105 transition-transform">
        ...
        {/* LIVE NOW */}
        <div className="relative rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface-subtle)] p-4 sm:p-5 shadow-[var(--shadow-flat)] hover:border-[#10b981]/50 transition-all group overflow-hidden">
          {/* Subtle Accent Strip */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#10b981]/15 text-[#10b981] border border-[#10b981]/30 group-hover:scale-105 transition-transform">
        ...
        {/* UPCOMING */}
        <div className="relative rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface-subtle)] p-4 sm:p-5 shadow-[var(--shadow-flat)] hover:border-[#38bdf8]/50 transition-all group overflow-hidden">
          {/* Subtle Accent Strip */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#38bdf8]/15 text-[#38bdf8] border border-[#38bdf8]/30 group-hover:scale-105 transition-transform">
      ...
      <div className="rounded-2xl bg-[var(--bg-surface-subtle)] p-4 sm:p-5 border border-[var(--border-subtle)] shadow-[var(--shadow-flat)]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-3.5 mt-3.5 border-t border-[var(--border-subtle)] animate-fadeIn">
            {WORKFLOW_STEPS.map((s) => {
              ...
              return (
                <div
                  key={s.step}
                  className="p-3.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] space-y-1.5 hover:border-[var(--accent-primary)]/50 transition-colors shadow-sm"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold text-[var(--accent-primary)]">
                      STEP 0{s.step}
                    </span>
                    <IconComp className="h-3.5 w-3.5 text-[var(--accent-primary)]" />
                  </div>
      ...
      <section className="space-y-5 p-5 sm:p-6 lg:p-7 rounded-3xl bg-[var(--bg-workspace)] border border-[var(--border-subtle)] shadow-[var(--shadow-flat)]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-medium)] text-xs sm:text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] shadow-sm focus:outline-none focus:border-[var(--accent-primary)] focus:ring-1 focus:ring-[var(--accent-primary)] transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3.5 py-2.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-medium)] text-xs font-bold text-[var(--text-primary)] shadow-sm cursor-pointer focus:outline-none focus:border-[var(--accent-primary)]"
            >
